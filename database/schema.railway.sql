-- ReVente-Auto — Schéma MySQL pour Railway
-- Importer ce fichier dans la base par défaut de Railway: `railway`
-- Conseillé: dans phpMyAdmin, sélectionner d'abord la base `railway` dans le panneau de gauche puis Importer ce fichier.
