<?php
/**
 * Page de modification de v�hicule - Version compl�te refonte
 * Syst�me multi-�tapes align� avec ajout_vehicule.php
  ...
  <div class="conteneur">
    <div class="modification-erreur-container">
      <div class="modification-erreur-card">
        ...
        <h2 class="modification-erreur-titre">Acc�s refus�</h2>
