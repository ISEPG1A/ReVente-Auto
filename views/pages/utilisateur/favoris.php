...
<section class="faq-hero">
    <div class="faq-hero__contenu">
        <div style="margin-bottom: 1rem;">
            <div class="favoris-hero__icon" style="font-size: 3rem; color: #ff6b6b; margin-bottom: 1rem;">
                <i class="fas fa-heart"></i>
            </div>
        </div>
        <h1 class="faq-hero__titre">Mes <span style="color: white;">Favoris</span></h1>
        <p class="faq-hero__description">Retrouvez tous les véhicules que vous avez sauvegardés</p>
        <div class="favoris-hero__stats" style="margin-top: 2rem;">
            <div class="favoris-stat" style="color: white;">
                <span id="favoris-count" class="favoris-stat__number" style="font-size: 2.5rem; font-weight: 700; display: block;">0</span>
                <span class="favoris-stat__label" style="font-size: 1rem; opacity: 0.9;">véhicule(s) sauvegardé(s)</span>
            </div>
        </div>
    </div>
