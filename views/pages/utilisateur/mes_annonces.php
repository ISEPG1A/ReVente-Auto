...
<section class="faq-hero">
    <div class="faq-hero__contenu">
        <div style="margin-bottom: 1rem;">
            <div class="annonces-hero__icon" style="font-size: 3rem; color: #ffd700; margin-bottom: 1rem;">
                <i class="fas fa-bullhorn"></i>
            </div>
        </div>
        <h1 class="faq-hero__titre">Mes <span style="color: white;">Annonces</span></h1>
        <p class="faq-hero__description">Gérez vos véhicules mis en vente et suivez leurs performances</p>
        <div class="annonces-hero__stats" style="margin-top: 2rem; display: flex; gap: 2rem; justify-content: center; flex-wrap: wrap;">
            <div class="annonces-stat" style="color: white; text-align: center;">
                <span id="annonces-count" class="annonces-stat__number" style="font-size: 2rem; font-weight: 700; display: block;">0</span>
                <span class="annonces-stat__label" style="font-size: 0.9rem; opacity: 0.9;">annonce(s) publiée(s)</span>
            </div>
            <div class="annonces-stat" style="color: white; text-align: center;">
                <span id="annonces-public-count" class="annonces-stat__number" style="font-size: 2rem; font-weight: 700; display: block;">0</span>
                <span class="annonces-stat__label" style="font-size: 0.9rem; opacity: 0.9;">publique(s)</span>
            </div>
            <div class="annonces-stat" style="color: white; text-align: center;">
                <span id="annonces-prive-count" class="annonces-stat__number" style="font-size: 2rem; font-weight: 700; display: block;">0</span>
                <span class="annonces-stat__label" style="font-size: 0.9rem; opacity: 0.9;">privée(s)</span>
            </div>
        </div>
    </div>
