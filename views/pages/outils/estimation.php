...
<section class="faq-hero">
    <div class="faq-hero__contenu">
        <div style="margin-bottom: 1rem;">
            <span style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 0.5rem 1rem; border-radius: 50px; font-size: 0.9rem; font-weight: 600;">
                <i class="fas fa-robot"></i> Propulsé par l'IA
            </span>
        </div>
        <h1 class="faq-hero__titre">Estimez la valeur de votre <span style="color: white;">véhicule</span></h1>
        <p class="faq-hero__description">Notre intelligence artificielle analyse les données du marché en temps réel pour vous fournir une estimation précise et fiable</p>
        <div style="display: flex; gap: 2rem; justify-content: center; margin-top: 2rem; flex-wrap: wrap;">
            <div style="display: flex; align-items: center; gap: 0.5rem; color: white;">
                ...
                <span style="font-weight: 500;">Résultat instantané</span>
            </div>
            <div style="display: flex; align-items: center; gap: 0.5rem; color: white;">
                <i class="fas fa-chart-line" style="color: #ffd700;"></i>
                <span style="font-weight: 500;">Données actualisées</span>
            </div>
            <div style="display: flex; align-items: center; gap: 0.5rem; color: white;">
                <i class="fas fa-shield-alt" style="color: #ffd700;"></i>
                <span style="font-weight: 500;">100% gratuit</span>
            </div>
        </div>
    </div>
