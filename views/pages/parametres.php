                    ...
                    <div id="section-verification" class="parametres-card">
                        <div class="parametres-card__header">
                            ...
                            <div>
                                ...
                                <p class="parametres-card__description">Vérifiez votre email et téléphone pour sécuriser votre compte</p>
                            </div>
                        </div>
                        ...
                        <div class="parametres-verifications">
                            ...
                            <div class="parametres-verification-item">
                                ...
                                <div class="parametres-verification-item__content">
                                    ...
                                    <p id="statut-telephone" class="parametres-verification-item__status">
                                        <i class="fas fa-circle"></i> Statut: inconnu
                                    </p>
                                </div>
                                <div class="parametres-verification-item__action parametres-verification-item__action--phone">
                                    <button id="bouton-code-telephone" class="parametres-btn parametres-btn--outline" type="button">
                                        <i class="fas fa-sms"></i> Recevoir code
                                    </button>
                                    <div class="parametres-verification-code">
                                        <input id="code-telephone" class="parametres-form__input" type="text" placeholder="Code reçu">
                                        <button id="bouton-verifier-telephone" class="parametres-btn parametres-btn--primary" type="button">
