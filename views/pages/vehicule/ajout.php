...
<script type="module">
    import VerificationEmailAjout from './assets/js/modules/vehicule/verificationEmailAjout.js?v=<?= time() ?>';
...
<section class="faq-hero" style="padding: 4rem 0;">
    <div class="faq-hero__contenu">
        <h1 class="faq-hero__titre">Publier une <span style="color: white;">annonce</span></h1>
        <p class="faq-hero__description">Complétez les étapes pour mettre votre véhicule en vente</p>
    </div>
...
<script type="module">
    import VueAjoutVehicule from './assets/js/modules/vehicule/VueAjoutVehicule.js?v=<?= time() ?>';
    document.addEventListener('DOMContentLoaded', () => {
